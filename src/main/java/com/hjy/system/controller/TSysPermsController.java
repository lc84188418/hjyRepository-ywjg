...
public class TSysPermsController {
     ...
     * @return 新增结果
     */
    @OperLog(operModul = "系统管理-权限管理-权限管理",operType = "添加",operDesc = "添加菜单")
...
//    @RequiresPermissions({"perms:add"})
     ...
     * @return 所有数据
     */
    @OperLog(operModul = "系统管理-权限管理-权限管理",operType = "查看",operDesc = "查看菜单信息")
    @RequiresPermissions({"perms:view"})
     ...
     * @return 删除结果
     */
    @OperLog(operModul = "系统管理-权限管理-权限管理",operType = "删除",operDesc = "删除菜单")
    @RequiresPermissions({"perms:view"})
//    @RequiresPermissions({"perms:del"})
     ...
     * @return 单条数据
     */
    @OperLog(operModul = "系统管理-权限管理-权限管理",operType = "查看",operDesc = "查看菜单详情")
     ...
     * @return 修改结果
     */
    @OperLog(operModul = "系统管理-权限管理-权限管理",operType = "修改",operDesc = "修改菜单信息")
    @RequiresPermissions({"perms:view"})
