...
//            jsonObject.put("permsList",perms);
     ...
     * @return 新增结果
     */
    @OperLog(operModul = "系统管理-权限管理-用户管理",operType = "添加",operDesc = "新增用户")
...
//    @RequiresPermissions({"user:add"})
     ...
     * @return 所有数据
     */
    @OperLog(operModul = "系统管理-权限管理-用户管理",operType = "查看",operDesc = "查看用户列表")
    @RequiresPermissions({"user:view"})
     ...
     * @return 删除结果
     */
    @OperLog(operModul = "系统管理-权限管理-用户管理",operType = "删除",operDesc = "删除用户")
    @RequiresPermissions({"user:view"})
//    @RequiresPermissions({"user:del"})
     ...
     * @return 单条数据
     */
    @OperLog(operModul = "系统管理-权限管理-用户管理",operType = "查看",operDesc = "查看用户详情")
     ...
     * @return 修改结果
     */
    @OperLog(operModul = "系统管理-权限管理-用户管理",operType = "修改",operDesc = "修改用户信息")
    @RequiresPermissions({"user:view"})
//    @RequiresPermissions({"user:update"})
     ...
     * @return 修改结果
     */
    @OperLog(operModul = "设置",operType = "修改",operDesc = "完善个人信息")
     ...
     * 5 分配角色
     */
    @OperLog(operModul = "系统管理-权限管理-用户管理",operType = "分配角色",operDesc = "给用户授予角色权限")
    @RequiresPermissions({"user:view"})
//    @RequiresPermissions({"user:distributeRole"})
    @PostMapping(value = "/system/user/distributeRole")
    public CommonResult roleDistribute(@RequestBody String param) throws FebsException{
        try {
            CommonResult commonResult = tSysUserService.roleDistribute(param);
            return commonResult;
        } catch (Exception e) {
     ...
     * @return 修改结果
     */
    @OperLog(operModul = "系统管理-权限管理-用户管理",operType = "重置密码",operDesc = "重置密码")
    @RequiresPermissions({"user:view"})
